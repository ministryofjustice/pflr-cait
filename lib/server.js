...
const normalizeAnalytics = (req, res) => {
...
const screenUsers = (ENV) => {
  ...
  router.use((req, res, next) => {
    ...
    if (!req.url.match(allowedRegex)) {
      ...
      // normalizeAnalytics(req, res)
      console.log('req.cookies.analytics', req.cookies.analytics)
      console.log('req.cookies.surveyData', req.cookies.surveyData)
      console.log(req.cookies.analytics == req.cookies.surveyData)
      if (false && (!req.cookies || !req.cookies.analytics)) {
